    ...
    <section>
                    ...
                    <el-row>
                        ...
                        <el-col :span="12" style="margin:40px auto;">
                            <el-form-item>
                                ...
                                <router-link to="/userManage/generateSettleList" style="margin-left:10px;"><el-button type="primary">去结算</el-button></router-link>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
        ...
        <el-card class="box-card" style="padding-bottom: 30px;">
            <el-table border :data="tableData" v-loading="listLoading" element-loading-text="加载中" style="width: 100%">
                ...
                <el-table-column align='center' prop="premium" label="保费（元）" width="120"></el-table-column>
                <el-table-column align='center' prop="createTime" label="结算时间" :formatter="dateFormat" width="200"></el-table-column>
                <el-table-column align='center' prop="isPay" label="状态" :formatter="statusText" width="150"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            userInfoDetails(row){
                this.$router.push({path:'/userManage/generateDetails',query: {parentStatementNo:row.statementNo,type:'2'}})
            },
            statusText(row){
                if(row.isPay == 0){
                    return '未支付'
