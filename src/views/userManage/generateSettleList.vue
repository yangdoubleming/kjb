    ...
    <section>
            ...
            <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
                <el-form :inline="true" :model="ruleForm" :rules="rules" label-position="top" ref="ruleForm" class="demo-form-inline">
                    ...
                    <el-form-item style="margin-top:40px;">
                        ...
                        <el-button type="primary" @click="getGenerate">生成结算单</el-button>
                    </el-form-item>
                </el-form>
            </el-col>
        </el-card>
        <el-card class="box-card" style="padding-bottom: 30px;">
            ...
            <el-table border :data="tableData" v-loading="listLoading" element-loading-text="加载中" style="width: 100%">
                ...
                <el-table-column align='center' prop="customerName" label="客户" width="280"> </el-table-column>
                <el-table-column align='center' prop="ticketNo" label="豆沙包订单号"   width=""></el-table-column>
                <el-table-column align='center' prop="productName" label="产品名"  width=""> </el-table-column>
                <el-table-column align='center' prop="productAmount" label="保费" width=""></el-table-column>
                <el-table-column align='center' prop="commission" label="手续费" width=""></el-table-column>
                <el-table-column align='center' prop="polNo" label="保司保单号" width=""></el-table-column>
                <el-table-column align='center' prop="orderDate" label="订单时间"  width="" :formatter="dateFormat"></el-table-column>
            </el-table>
...
<script>
    ...
    import { getSettlementListForBaosi, getCompanyListName, exportOrderToExcelForBaosi, generateSettlementListForBaosi } from '@/api/userManage'
    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                getSettlementListForBaosi(this.ruleForm).then(response => {
            ...
            setDate(){
                ...
                this.ruleForm.startTime = newday
                this.ruleForm.endTime = newday
            },
            getGenerate(){
                this.listLoading = true
                generateSettlementListForBaosi(this.ruleForm).then(response => {
